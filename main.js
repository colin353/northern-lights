...
(function() {
  var Enemy, EnemyPrototype, GImage, GInputEvent, GMap, MapController, Prototype, Tower, TowerPrototype, ViewController, isMobileSafari, randomizeVector, simplifyPath, tick, vectorLength, vectorSubtract, viewcontroller, _ref, _ref1,
    __slice = [].slice,
  ...
  ViewController = (function() {
    ...
    ViewController.prototype.ready = function() {
      var a, b, _i, _j, _len, _len1, _ref2;

      _ref2 = [this.images, this.map, this.prototypes];
  ...
  Tower = (function() {
    ...
    Tower.prototype.tick = function() {
      ...
      document.viewcontroller.renderSprite(this.prototype.image, this.position.x, this.position.y, 1);
      _ref2 = document.viewcontroller.stack[0].rats;
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        r = _ref2[_i];
